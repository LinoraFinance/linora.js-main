...
```typescript
const config = await linora.Config.fetch('mainnet');
```

### Custom Environment

```typescript
const config = await linora.Config.fetch(
...
- See the [React example app](https://github.com/tradelinora/linora-react-example) for browser integration
- Join [Discord](https://discord.gg/linora) for support
...
**Need help?** Join our [Discord](https://discord.gg/linora) community!
