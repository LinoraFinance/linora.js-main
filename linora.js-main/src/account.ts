...
/**
 * Derives linora account credentials from an Ethereum wallet.
...
/**
 * Generates a linora account from an Ethereum wallet.
 * @deprecated Use deriveFromEthSigner() and pass credentials to DefaultProvider constructor
 * @returns The generated linora account.
 */
...
/**
 * Derives linora account credentials from a Starknet account.
 * Internal use only - use linoraClient.createFromStarknetAccount() instead.
 * @internal
 * @returns The account address and private key.
 */
...
/**
 * Generates a linora account from a Starknet signer.
