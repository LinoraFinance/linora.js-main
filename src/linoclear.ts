...
/**
 * Socialized losses happen when linora Insurance Fund is bankrupt
...
interface GetReceivableAmountParams {
  ...
  readonly token: string;
  /**
   * Amount of to withdraw from linora, as a decimal string.
...
interface GetReceivableAmountResult {
  /**
   * Amount that will be received from linora, after socialized loss,
...
interface WithdrawParams {
  ...
  readonly token: string;
  /**
   * Amount to withdraw from linora.
