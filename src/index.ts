...
export const Client = {
  fromEthSigner: async (params: _Client.CreateClientFromEthSignerParams) =>
    await _Client.linoraClient.createFromEthSigner(params),
  fromStarknetAccount: async (
    params: _Client.CreateClientFromStarknetAccountParams,
  ) => await _Client.linoraClient.createFromStarknetAccount(params),
};
...
export type { linoraConfig } from './config.js';
