import { buildConfig, type RawlinoraConfig } from '../src/config';

describe('buildConfig', () => {
  test('returns the correct config object', () => {
    const rawConfig: RawlinoraConfig = {
      starknet_gateway_url: 'https://potc-testnet-sepolia.starknet.io',
      starknet_fullnode_rpc_url:
        'https://pathfinder.api.testnet.linora.trade/rpc/v0_7',
      starknet_chain_id: 'PRIVATE_SN_POTC_SEPOLIA',
      block_explorer_url: 'https://voyager.testnet.linora.trade/',
      paraclear_address:
    ...
    const expectedConfig = {
      ...
      paraclearAddress:
        '0x286003f7c7bfc3f94e8f0af48b48302e7aee2fb13c23b141479ba00832ef2c6',
      paraclearDecimals: 8,
      linoraChainId: 'PRIVATE_SN_POTC_SEPOLIA',
      linoraFullNodeRpcUrl:
        'https://pathfinder.api.testnet.linora.trade/rpc/v0_7',
    };
